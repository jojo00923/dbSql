...
SELECT sido, sigungu, count(*) 분자
FROM fastfood
WHERE gb IN ('버거킹', '맥도날드', 'KFC')
GROUP BY sido, sigungu;

SELECT sido, sigungu, count(*) 분모
FROM fastfood
WHERE gb='롯데리아'
GROUP BY sido, sigungu;

SELECT b.sido, b.sigungu, a.분자, b.분모, ROUND(a.분자/b.분모, 1) as 결과
FROM 
(SELECT sido, sigungu, count(*) 분자
FROM fastfood
WHERE gb IN ('버거킹', '맥도날드', 'KFC')
...
CREATE INDEX HAMBERGER ON fastfood (sido, sigungu);
